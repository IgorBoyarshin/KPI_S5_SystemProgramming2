...
public class SyntaxAnalyzer {
            ...
            case KEYWORD_FOR:
                {
                    ...
                    final int boundResultingIndex = processExpression(lexemes, index);
            ...
            case KEYWORD_IF:
                {
                    ...
                    final int expressionResultingIndex = processExpression(lexemes, index);
    ...
    private int processExpression(List<Lexeme> lexemes, int index) {
    ...
    private Piece reduceIntoPiece(List<Piece> pieces) {
        ...
        do {
            ...
            switch (operator.pieceType) {
                ...
                case OPERATOR_EQUALS:
                case OPERATOR_NOT_EQUALS:
                    newPiece = new Piece(PieceType.EXPRESSION, Type.INTEGER);
                    break;
                default:
                    System.out.println(" Syntax Analyzer Error : " +
